...
config :bonny,
  ...
  get_conn: {BonnyExample.K8sConn, :get!, [config_env()]},

  # Name must only consist of only lowercase letters and hyphens.
  # Defaults to hyphenated mix app name
  service_account_name: "bonny-example",

  # Labels to apply to the operator's resources.
  labels: %{
    "k8s-app" => "bonny-example"
  },

  # Operator deployment resources. These are the defaults.
  resources: %{limits: %{cpu: "200m", memory: "200Mi"}, requests: %{cpu: "200m", memory: "200Mi"}},

  manifest_override_callback: &Mix.Tasks.Bonny.Gen.Manifest.BonnyExampleCustomizer.override/1
